...
// import 'package:messaging_in_firebase/models/MessageModel.dart';
...
//       FirebaseFirestore.instance.collection("chatrooms").doc(widget.chatroom.chatroomid).set(newMessage.toMap());
//       log("Message Sent");
//     }
//   }
...
//                       ("messages").orderBy("createdon").snapshots(),
...
//                               MessageModel currentMessage = MessageModel.formMap(dataSnapshot.docs[index].data() as Map<String, dynamic>);
...
//                                 return Center(
//                                   child: Text("An erro occured!n Please check you internet connection"),
//                                 );
//                             }else{
//                               return Center(
