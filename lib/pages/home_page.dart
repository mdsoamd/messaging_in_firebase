...
// import 'package:messaging_in_firebase/pages/SearchPage.dart';
                ...
                if(snapshot.hasData) {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ChatRoomModel chatRoomModel = ChatRoomModel.formMap(chatRoomSnapshot.docs[index].data() as Map<String, dynamic>);
